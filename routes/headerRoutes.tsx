...
import DashboardHeader from '../pages/admin/_layout/_headers/DashboardHeader';
import DashboardBookingHeader from '../pages/admin/_layout/_headers/DashboardBookingHeader';
import ProfilePageHeader from '../pages/admin/_layout/_headers/ProfilePageHeader';
import SummaryHeader from '../pages/admin/_layout/_headers/SummaryHeader';
import ProductsHeader from '../pages/admin/_layout/_headers/ProductsHeader';
import ProductListHeader from '../pages/admin/_layout/_headers/ProductListHeader';
import PageLayoutHeader from '../pages/admin/_layout/_headers/PageLayoutHeader';
import ComponentsHeader from '../pages/admin/_layout/_headers/ComponentsHeader';
import FormHeader from '../pages/admin/_layout/_headers/FormHeader';
import ChartsHeader from '../pages/admin/_layout/_headers/ChartsHeader';
import ContentHeader from '../pages/admin/_layout/_headers/ContentHeader';
