...
import {
	...
	ClusterStore,
	ClusterShow,
} from '@call-root-lib/services/ClusterServices/ClusterService';
...
const CommonCluster: FC<IDataLahanProps> = ({ isFluid }) => {
	...
	const handleEditLahan = async (id: string) => {
		console.log('uuid : ', id);
		setEditClusterModal(!editClusterModal);
		const showData = await ClusterShow(id);
